            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tr>
                            <th>Photo</th>
                            <td><img class="img-thumbnail post_image" data-src="{{$post->photo}}" src="{{$post->photo}}" alt="{{$post->title}}"> </td>
                        </tr>
                        <tr>
                            <th>Tags</th>
                            <td>
                                ...
                                @foreach($post->tag as $tag)
                                    <a href="{{route('tag.show', $tag->id )}}"><button class="btn btn-sm {{$classes[random_int(0,4)]}} mb-1"> {{$tag->name}}</button></a>
                                @endforeach
                            </td>
                        </tr>
                        </tbody>
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="{{route('category.show', $post->category_id)}}"><button class="btn-success btn-sm btn">Details</button></a>
                </div>
            </div>
            <div class="card mt-4">
                <div class="card-header">
                ...
                <div class="card-body">
                    ...
                    <a href="{{route('sub-category.show', $post->sub_category->id)}}"><button class="btn-success btn-sm btn">Details</button></a>
                </div>
            </div>
            <div class="card mt-4">
                <div class="card-header">
